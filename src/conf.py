...
BLOG_AUTHOR = "the-old-mayhem"  # (translatable)
BLOG_TITLE = "Old Mayhem Mirror"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://the-old-mayhem.tumblr.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://tom.madr.se/"
BLOG_EMAIL = "yttan@fastmail.se"
BLOG_DESCRIPTION = "Mirror of the-old-mayhem tumblr log"  # (translatable)
